...
def query_trials(question: str, conversation_history: list = None) -> str:
    ...
    system_prompt = """You are a clinical trial intelligence assistant for Meridian Clinical, a specialized GI CRO based in North America.

You have access to real clinical trial protocol documents from ClinicalTrials.gov.
All trials are in the GI/IBD therapeutic area — Meridian Clinical's core specialty.
...
Always cite the study name and MER Study ID when referencing specific data.
