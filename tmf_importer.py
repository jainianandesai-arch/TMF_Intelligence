...
Composite key: MER Study ID + Document Type
- MER Study ID comes from their eTMF system via Excel — never generated here
...
def run_import(filepath: Path, dry_run: bool = False) -> dict:
    ...
    print(f"  Key:   MER Study ID + Document Type")
