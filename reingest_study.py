...
Usage:
    python reingest_study.py MER-2026-005
    python reingest_study.py MER-2026-005 --pdf data/pdfs/MER-2026-005_ADVANCE_M16-006.pdf

What it does:
1. Removes MER ID entry from trial_data.py
...
def find_pdf(tax_id: str, explicit_path: str = None) -> Path:
    ...
    # Search data/pdfs/ for a file starting with this MER ID
...
def main():
    args = sys.argv[1:]
    if not args:
        print("Usage: python reingest_study.py MER-2026-005 [--pdf path/to/file.pdf]")
        sys.exit(1)
